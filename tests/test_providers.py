...
class TestProviderManager:
    ...
    def test_parse_provider_name(self, provider_manager):
        ...
        assert provider_manager._parse_provider_name("CUDA") == ExecutionProvider.CUDA
        assert provider_manager._parse_provider_name("coreml") == ExecutionProvider.COREML
        assert provider_manager._parse_provider_name("core") == ExecutionProvider.COREML
        assert provider_manager._parse_provider_name("tensorrt") == ExecutionProvider.TENSORRT
        assert provider_manager._parse_provider_name("trt") == ExecutionProvider.TENSORRT
        assert provider_manager._parse_provider_name("rocm") == ExecutionProvider.ROCM
        assert provider_manager._parse_provider_name("directml") == ExecutionProvider.DIRECTML
        assert provider_manager._parse_provider_name("dml") == ExecutionProvider.DIRECTML
        assert provider_manager._parse_provider_name("openvino") == ExecutionProvider.OPENVINO
